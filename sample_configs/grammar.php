...
return [
	'rules' => [
			...
			'T_STATEMENT'	=>[
				...
				['T_NOUN_PHRASE','T_MODALITY|optional','T_VERB_PHRASE', 'T_PREP_PHRASE', 'T_PUNCTUATION'],
	...
	'commands' => [
			...
			'T_DIRECTOR'	=>[
				'expects'=>['T_WHITESPACE','T_OPERATOR','T_DESCRIPTOR','T_ENTITY','T_SYMBOL','T_ALIAS','T_INDICATOR','T_PUNCTUATION']],
			'T_INTERJECTION'=>[
				'expects'=>['T_WHITESPACE','T_PUNCTUATION']],
		],
];